...
### Since we can't track vmware-tools updates and refresh ova each time there is an update,
### make sure that when you deploy OVA you upgrade vmware-tools from the platform OVA deployed to! 
### For how to simple google it.
